...
import { getAiPage } from "@/lib/pages";
import { createPageMetadata } from "@/lib/seo";

export const metadata: Metadata = createPageMetadata({
  title: "AI Experiments",
  description: "Generative worlds and hybrid AI workflows by Sugandha Saxena.",
  path: "/ai",
});

export default function AiPage() {
  // All content for this page is configured in content/pages/ai.yaml
  const { eyebrow, headline, subtitle, items } = getAiPage();
